                    ...
                    <ConfigSection title="Call History" description="Settings for call history persistence and retention.">
                        <ConfigCard>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="col-span-full">
                                    <FormInput
                                        label="Database URL (PostgreSQL)"
                                        value={env['DATABASE_URL'] || ''}
                                        onChange={(e) => updateEnv('DATABASE_URL', e.target.value)}
                                        placeholder="postgresql://user:pass@host:port/dbname"
                                        tooltip="PostgreSQL connection string (recommended for production). Leave empty to use SQLite."
                                    />
                                </div>
                                <div className="col-span-full">
                                    <FormInput
                                        label="Database Path (SQLite fallback)"
                                        ...
                                        tooltip="Used only when DATABASE_URL is not set."
                                    />
                                </div>
                            </div>
                        </ConfigCard>
